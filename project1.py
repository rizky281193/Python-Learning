...
cap.set(3,frameWidth) # set color
cap.set(4,frameHeight) # set ratio
cap.set(10,100) # set brigness

myColors = [[105,95,20,119,255,255]] #blue

myColorValue = [[255,128,0]]  # color BGR from website rapidtables
